...
class Bayar extends Component
{
    public $snapToken;
    public $belanja;
    public $va_number,$gross_amount,$bank,$transaction_status,$deadline,$pengiriman;
    ...
    public function mount($id)
    {
        if(!Auth::user())
        {
          ...
          \Midtrans\Config::$serverKey = 'SB-Mid-server-ClWoGjPwjdTgGuiOyJEvvr02';
          ...
          if(!empty($this->belanja))
          {
            ...
            else if($this->belanja->status == 2)
            {
                ...
                $this->pengiriman               = $this->belanja->jenis_service_pengiriman;
            }
          }
    }
